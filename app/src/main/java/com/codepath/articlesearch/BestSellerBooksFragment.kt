 ...
 */
class BestSellerBooksFragment(private val days: ArrayList<Day>) : Fragment(), OnListFragmentInteractionListener {
...
//        progressBar.show()
        progressBar.hide()
        val adapter = DayAdapter(this.requireContext(), days)
